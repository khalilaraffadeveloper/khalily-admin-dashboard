...
class ARAVAApp : Application() {
    ...
    private fun configureFirestore() {
        try {
            ...
            android.util.Log.d("ARAVAApp", "Firestore persistent cache enabled for ARAVA-app")
        } catch (e: Exception) {
            android.util.Log.e("ARAVAApp", "Firestore connection failed: ${e.message}")
        }
    }

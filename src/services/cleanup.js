/**
 * Khalily Data Lifecycle Manager
...
async function runCleanup() {
    console.log('========================================');
    console.log(`[Khalily Cleanup] Starting at ${new Date().toISOString()}`);
    console.log('========================================');
    ...
    try {
        ...
        console.log('========================================');
        console.log('[Khalily Cleanup] Summary:');
        ...
        console.error('[Khalily Cleanup] Error:', error);
        throw error;
    }
}

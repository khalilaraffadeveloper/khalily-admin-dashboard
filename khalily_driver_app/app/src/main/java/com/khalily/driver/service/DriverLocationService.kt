...
import com.khalily.driver.util.GeoHashUtil
import com.khalily.driver.util.NetworkUtil
...
class DriverLocationService : Service() {
    ...
    private fun buildNotification(): Notification {
        ...
        return NotificationCompat.Builder(this, KhalilyApp.LOCATION_SERVICE_CHANNEL)
            .setContentTitle("Khalily Driver")
